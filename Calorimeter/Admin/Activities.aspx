<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminThem.Master" AutoEventWireup="true" CodeBehind="Activities.aspx.cs" Inherits="Calorimeter.Admin.Activities" %>
                ...
                <asp:panel id="addNew" runat="server" Visible="false">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <asp:TextBox ID="Metabolism" runat="server" class="form-control"></asp:TextBox>
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please fill this field!" ControlToValidate="Metabolism" Font-Bold="True" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </div>  
                   ...
                   <asp:Panel ID="showList" runat="server">
                    ...
                    <div class="container">
                        <div class="row">
                            <asp:GridView ID="ActivitiesList" runat="server" CellPadding="5" CellSpacing="5" ForeColor="#333333" GridLines="Horizontal"  style="width: 100%; word-wrap:break-word; table-layout: fixed;" OnRowCommand="Activities_RowCommand" OnRowDataBound="Activities_RowDataBound">
                                <Columns>
                                    <asp:TemplateField >
