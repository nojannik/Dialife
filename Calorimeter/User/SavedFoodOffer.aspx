<%@ Page Title="" Language="C#" MasterPageFile="UserThem.Master" AutoEventWireup="true" CodeBehind="SavedFoodOffer.aspx.cs" Inherits="Calorimeter.User.SavedFoodOffer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table  id="dietplan-css" class="table table-bordered" >
        <thead>
            <tr>
                <th>Day of Week</th>
                <th>Breakfast</th>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="TotalSat" runat="server" OnClientClick="MyFunction(test); return false;"   style="color:black;"   onclick="LinkButton2_Click" ForeColor="#FF0066" ></asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:LinkButton ID="TotalSun" runat="server" OnClientClick="MyFunction(test); return false;"   style="color:black;"   onclick="LinkButton2_Click" ForeColor="#FF0066" ></asp:LinkButton>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="TotalMon" runat="server" OnClientClick="MyFunction(test); return false;"   style="color:black;"   onclick="LinkButton2_Click" ForeColor="#FF0066" ></asp:LinkButton>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="TotalTue" runat="server" OnClientClick="MyFunction(test); return false;"   style="color:black;"   onclick="LinkButton2_Click" ForeColor="#FF0066" ></asp:LinkButton>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="TotalWed" runat="server" OnClientClick="MyFunction(test); return false;"   style="color:black;"   onclick="LinkButton2_Click" ForeColor="#FF0066" ></asp:LinkButton>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="TotalThurs" runat="server" OnClientClick="MyFunction(test); return false;"   style="color:black;"   onclick="LinkButton2_Click" ForeColor="#FF0066" ></asp:LinkButton>
                </td>
             ...
             <tr>
                ...
                <td>
                 ...
                 <td>
                    <asp:LinkButton ID="TotalFri" runat="server" OnClientClick="MyFunction(test); return false;"   style="color:black;"   onclick="LinkButton2_Click" ForeColor="#FF0066" ></asp:LinkButton>
                </td>
